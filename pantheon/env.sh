...
export PANTHEON_WORKFLOW_VERSION=`awk '/workflow_version/{print $NF}' pantheon/pantheon.yaml`
...
export PANTHEON_WORKFLOW_ID_DIR=$PANTHEON_PROJECT_DIR/$PANTHEON_WORKFLOW_ID
export PANTHEON_WORKFLOW_DIR=$PANTHEON_WORKFLOW_ID_DIR/$PANTHEON_WORKFLOW_VERSION
...
echo PANTHEON_WORKFLOW_ID_DIR..: $PANTHEON_WORKFLOW_ID_DIR
...
echo PANTHEON_WORKFLOW_VERSION.: $PANTHEON_WORKFLOW_VERSION
